...
RayTracingShaderGroupCreateInfo_Empty::RayTracingShaderGroupCreateInfo_Empty()
{
...
ImageCreateInfo_Default::ImageCreateInfo_Default(VkImageUsageFlags usageFlags, VkExtent2D extent, VkFormat format)
{
...
ImageCreateInfo_Default::ImageCreateInfo_Default(VkImageUsageFlags usageFlags, VkExtent3D extent, VkFormat format)
{
	std::memset(this, 0, sizeof(ImageCreateInfo_Default));
	this->sType                 = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
	this->pNext                 = nullptr;
...
SamplerCreateInfo_Default::SamplerCreateInfo_Default(float maxLodValue)
{
...
SamplerCreateInfo_Default::SamplerCreateInfo_Default() :
    SamplerCreateInfo_Default(0.0f)
{}

ImageViewCreateInfo_Default::ImageViewCreateInfo_Default(const VkImage &vkImage, const VkFormat &vkFormat)
{
...
ImageViewCreateInfo3D_Default::ImageViewCreateInfo3D_Default(const VkImage &vkImage, const VkFormat &vkFormat)
{
